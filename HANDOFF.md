...
up. **Canonical detail lives elsewhere**, this file links out instead of
...
- **Direct to `main`:** this repo deploys from `main` and the agent commits
  there daily, the established workflow is commit-to-main. This repo does not use feature
