...
export const GLOSSARY: GlossaryEntry[] = [
  ...
  },
  {
    ...
    soWhat: "Inbound transfers from non-enforcing jurisdictions often arrive with thin data — treat data completeness as a risk score, not a yes/no.",
    source: { name: "FATF", url: "https://www.fatf-gafi.org/" },
  },
  {
    id: "vasp",
  ...
  // ---- Authorities & lists ----
  {
    ...
    short: "US Office of Foreign Assets Control — administers US sanctions and maintains the SDN list.",
  ...
  },
  {
    ...
    term: "ESMA",
    category: "Authorities & lists",
    short: "European Securities and Markets Authority — co-ordinates MiCA supervision across the EU.",
  },
