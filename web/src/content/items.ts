...
export const ITEMS: Item[] = [
  ...
  },
  {
    ...
    soWhat:
      "Defines who must be FCA-authorised to offer crypto activities in the UK; it sharpens the bright line between authorised and unauthorised crypto counterparties ahead of the ~Oct 2027 regime.",
    date: "2025-12-16",
    addedAt: "2026-06-07",
    addedBy: "human",
    status: "published",
  ...
  },
  {
    ...
    soWhat:
      "Draws the bright line on what crypto activity needs FCA authorisation; it directly informs which crypto counterparties must be authorised, and when 'unauthorised' becomes a red flag.",
    date: "2026-04-15",
    addedAt: "2026-06-07",
    addedBy: "human",
    status: "published",
